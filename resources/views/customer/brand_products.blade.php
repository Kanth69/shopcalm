                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div class="col-md-6 d-flex align-items-center gap-3">
                            @if($brand->logo)
                                <img src="{{ asset('storage/' . $brand->logo) }}" alt="{{ $brand->name }}" class="rounded shadow-sm border p-1 bg-white" style="width: 60px; height: 60px; object-fit: contain;">
                            @else
                                <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 60px; height: 60px;">
            ...
            <div class="row content-loaded d-none g-4">
                ...
                @empty
                    <div class="col-12 text-center py-5">
                        ...
                        <p class="text-muted">We are currently restocking this brand. Please check back later.</p>

            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img id="logoPreview" src="{{ $brand->logo ? asset('storage/' . $brand->logo) : '#' }}" alt="Preview" class="img-thumbnail {{ $brand->logo ? '' : 'd-none' }}" style="max-height: 200px; object-fit: contain;">
                        </div>
                    </div>
                </div>
            </div>
